...
<div class="col-6">
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
        ...
        <div class='col-sm-12 col-md-7'>
            <input id='id' type='hidden' class='form-control' placeholder='npsn' name='id' value=''>
            <input disabled id='npsn' type='text' class='form-control' placeholder='npsn' name='npsn' value='{{ $unit->npsn }}'>
        </div>
    </div>
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
            for='nama_satuan_pendidikan'>Nama Satuan Pendidikan</label>
        <div class='col-sm-12 col-md-7'> <input disabled id='nama_satuan_pendidikan' type='text' class='form-control'
                placeholder='nama_satuan_pendidikan' name='nama_satuan_pendidikan' value='{{ $unit->nama }}'>
        </div>
    </div>
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
    ...
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
            for='no_sk'>NO
            SK</label>
        <div class='col-sm-12 col-md-7'> <input disabled id='no_sk' type='text' class='form-control' placeholder='no_sk'
                name='no_sk' value='{{ $unit->no_sk }}'>
        </div>
    </div>
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
            for='tgl_sk'>TGL
...
<div class="col-6">
    ...
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
        ...
        <div class='col-sm-12 col-md-7'> <input id='kecamatan' type='text' class='form-control' placeholder='kecamatan'
                name='kecamatan' value='{{ $unit->kecamatan }}'>
            @error('kecamatan')
    ...
    <div class='form-group row mb-4'>
        ...
        <div class='col-sm-12 col-md-7'> <input id='kelurahan' type='text' class='form-control' placeholder='kelurahan'
                name='kelurahan' value='{{ $unit->kelurahan }}'>
        </div>
    </div>
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3' for='alamat'>
            Alamat
        </label>
        <div class='col-sm-12 col-md-7'> <input id='alamat' type='text' class='form-control' placeholder='alamat'
                name='alamat' value='{{ $unit->alamat }}'>
        </div>
    </div>
    <div class='form-group row mb-4'>
    ...
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3' for='hpks'>
        ...
        <div class='col-sm-12 col-md-7'>
            <input id='hpks' type='text' class='form-control' placeholder='No HP Kepala Sekolah' name='hpks' value='{{ $unit->no_ks }}'>
            @error('hpks')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3' for='namapj'>
    ...
    <div class=' form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3' for='hppj'>
    ...
    <div id="collapse2" class='form-group row mb-4'> <label class='col-form-label ' for='lokasi'>Masa
            Berakhir Ijop</label>
        <div class='col-sm-12 col-md-7'>
            <input id='masa_ijop' type='input' class='form-control datepicker' placeholder='masa_ijop' name='masa_ijop'
                value='{{ $unit->masa }}'>
        </div>
    </div>
    <div class='form-group row mb-4'>
        <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3' for='status'>Kondisi Lembaga</label>
        <div class='col-sm-12 col-md-7'>
            <div class="col-md12">
                <input checked="" type="radio" id="kondisi1" value="1" name="kondisi" class="form-control-input">
                <label class="col-form-label" for="kondisi1">Masih Buka</label>
            </div>
            <div class="col-md12">
                <input checked="" type="radio" id="kondisi2" value="0" name="kondisi" class="form-control-input">
    ...
    <div id="field_bt" class='form-group row mb-4'> <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
            for='kelas'>KELAS
