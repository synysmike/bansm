                        ...
                        <div class="col-6">
                            <div class='form-group row mb-4'> <label
                                ...
                                <div class='col-sm-12 col-md-7'><input disabled id='npsn' type='text'
                                        class='form-control' placeholder='npsn' name='npsn' value=''></div>
                            </div>
                            <div class='form-group row mb-4'> <label
                                    class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
                                ...
                                <div class='col-sm-12 col-md-7'><input disabled id='nama_satuan_pendidikan' type='text'
                                        ...
                                        name='nama_satuan_pendidikan' value=''></div>
                            </div>
                            <div class='form-group row mb-4'> <label
                                    class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
                            ...
                            <div class='form-group row mb-4'> <label
                                ...
                                <div class='col-sm-12 col-md-7'><input disabled id='status' type='text'
                                        class='form-control' placeholder='status' name='status' value=''></div>
                            </div>
                            <div class='form-group row mb-4'> <label
                                    class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
                                    for='alamat'>Alamat</label>
                                <div class='col-sm-12 col-md-7'><input id='alamat' type='text' class='form-control'
                                        placeholder='alamat' name='alamat' value=''></div>
                            </div>
                            <div class='form-group row mb-4'> <label
                                    class='col-form-label text-md-right col-12 col-md-3 col-lg-3'
